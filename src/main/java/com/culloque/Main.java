...
public class Main {
    public static void main(String[] args) {
        ...
        experience1.setDescription("Como Líder de Producto de Software, mi principal responsabilidad fue estimar, supervisar y desarrollar proyectos, diseñando arquitecturas sólidas, escalables y altamente disponibles, integrables con terceros, con altos estándares de calidad. Me enfoqué en ofrecer mejoras continuas al producto, alineadas con las expectativas establecidas.");
        ...
        experience1.addOutstandingAchievements("Desarrollé una aplicación de gestión de acceso basada en reconocimiento facial, mejorando significativamente los tiempos de acceso de pacientes, visitantes y empleados.");
        experience1.addOutstandingAchievements("Participé en equipos de investigación para construir y desarrollar modelos de aprendizaje automático, apoyando la toma de decisiones médicas y permitiendo decisiones informadas por parte del personal de atención.");
